...
\litem{
  ...
  \litem{
  \begin{align*}
    \left(\frac{6}{7}\right)^3 &= \frac{6^{-3}}{7^{-3}} \\
    &= \frac{1}{6^3} * \frac{7^3}{1} \\
    &= \frac{343}{216}
  \end{align*}
  \begin{align*}
...
\litem{
  \begin{align*}
    \left(\frac{a}{b}\right)^n &= \frac{a^n}{a^n} 
  \end{align*}
}
\litem{
  \begin{align*}
    \left(\frac{a}{b}\right)^{-n} &= \frac{a^{-n}}{b^{-n}} \\
    &= \frac{1}{a^n} * \frac{b^n}{1} \\
    &= \frac{b^n}{a^n}
  \end{align*}
}
\end{enumerate}
